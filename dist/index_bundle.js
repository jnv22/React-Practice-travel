...
/***/ function(module, exports, __webpack_require__) {
	...
	styles: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./app.scss\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	console.log(path.resolve(__dirname, "app/styles"));

	var Springboard = _react2.default.createClass({
	...
	_reactDom2.default.render(_react2.default.createElement(Springboard, { date: new Date() }), document.getElementById('app'));
